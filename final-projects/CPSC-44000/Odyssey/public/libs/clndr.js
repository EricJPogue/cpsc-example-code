...
(function (factory) {
  ...
  var clndrTemplate =
    "<div class='text-center row align-items-end clndr-controls'>" +
        "<div class='col clndr-control-button'>" +
            "<span class='btn-lg clndr-previous-button'>previous</span>" +
        '</div>' +
        "<div class='col h5 month'><%= month %> <%= year %></div>" +
        "<div class='col clndr-control-button'>" +
            "<span class='btn-lg clndr-next-button'>next</span>" +
        '</div>' +
    '</div>' +
    '<div class="center">'+
    "<table class='table table-bordered  clndr-table' >" +
        '<thead>' +
            "<tr class='text-center header-days'>" +
        ...
        '<% for(var i = 0; i < numberOfRows; i++){ %>' +
            ...
            '<% var d = j + i * 7; %>' +
                "<td class='<%= days[d].classes %>'>" +
                    "<div class='text-right day-contents'><%= days[d].day %></div>" +
                    "<div class='small text-center' id='day<%=[d]%>Events'>Matches <%=days[d].events.length%></div>" +
                '</td>' +
            '<% } %>' +
            '</tr>' +
        '<% } %>' +
